...
You can download the raw source code for these lecture notes [here](compmus2024-w08.Rmd).

## Course Meeting Plan

### Wednesday · 21 February · Lecture
...
Just once, you need to install the `compmus` package, a special package I wrote for this course to sand off some rough edges in `spotifyr`. First, you will need to install the `remotes` package from the Tools menu. Then you can install compmus with the following line of code:
