...
This page will host lecture notes and exercises for each week, as well as further examples to inspire you.

For now, have a quick look at some of the exmaple to get an idea of what will be possible for you by the end of the course, and then focus on 'What Makes a Good Corpus?'.

In a couple weeks, you will have your own storyboard and may want to look at exactly how I created this one. 
You can download the raw source code [here](./index.Rmd).
